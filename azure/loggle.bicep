...
install -d -m 0755 /etc/loggle
cat <<'EOF' >/etc/loggle/infra.env
LOGGLE_KEY_VAULT_NAME="{0}"
LOGGLE_MANAGED_IDENTITY_CLIENT_ID="{1}"
EOF
...
resource infraEnvExtension 'Microsoft.Compute/virtualMachines/extensions@2023-09-01' = {
  name: 'loggleInfraEnv'
